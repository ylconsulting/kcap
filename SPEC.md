...
本文档定义 **KCAP v1.0** 的格式与一致性要求。
本文档中的关键字 **MUST**、**MUST NOT**、**SHOULD**、**SHOULD NOT**、**MAY** 按 [RFC 2119](https://www.rfc-editor.org/rfc/rfc2119) / [RFC 8174](https://www.rfc-editor.org/rfc/rfc8174) 的含义解释。
...
- [4. Physical Forms](#4-physical-forms)
  - [4.1 Loose Form](#41-loose-form)
  - [4.2 Package Form](#42-package-form)
- [5. Package Layout](#5-package-layout)
- [6. Core Files](#6-core-files)
  - [6.1 kcap.json](#61-kcapjson)
  - [6.2 knowledge.md](#62-knowledgemd)
  - [6.3 knowledge.map.json](#63-knowledgemapjson)
- [7. Manifest Model](#7-manifest-model)
  - [7.1 Top-level Field Format Conventions](#71-top-level-field-format-conventions)
- [8. Top-level vs knowledge](#8-top-level-vs-knowledge)
- [9. Sources](#9-sources)
  - [9.1 General](#91-general)
  - [9.2 Source Fields](#92-source-fields)
  - [9.3 Snapshots](#93-snapshots)
- [10. Composition](#10-composition)
- [11. Metadata Objects](#11-metadata-objects)
  - [11.1 knowledge](#111-knowledge)
  - [11.2 resources](#112-resources)
  - [11.3 extras](#113-extras)
  - [11.4 pipeline](#114-pipeline)
- [12. Knowledge Map（来源锚点映射）](#12-knowledge-map来源锚点映射)
  - [12.1 Data Model](#121-data-model)
  - [12.2 Locator Abstraction](#122-locator-abstraction)
  - [12.3 Mapping Records](#123-mapping-records)
  - [12.4 Source Contributions & Segments](#124-source-contributions--segments)
  - [12.5 Design Boundaries](#125-design-boundaries)
- [13. Conformance](#13-conformance)
  - [13.1 Ingestion Validation Recommendations](#131-ingestion-validation-recommendations)
- [14. Minimal Example](#14-minimal-example)
- [15. Full Ingestion Example](#15-full-ingestion-example)
- [16. Security and Integrity Considerations](#16-security-and-integrity-considerations)
...
| 术语 | 定义 |
| --- | --- |
| **Capsule** | 一个 KCAP 封装对象。 |
| **Source** | capsule 的原始来源。一个 capsule **MAY** 有一个或多个 sources。 |
| **Resource** | 与知识内容直接相关、且可能在正文中被引用的附属资源。 |
| **Extra** | 非核心、可忽略的附属内容，用于扩展、调试、快照或平台特定用途。 |
| **Loose Form** | 目录形态的 KCAP。 |
| **Package Form** | 单文件形态的 KCAP。 |
...
KCAP capsule **MAY** 包含一个名为 `knowledge.map.json` 的可选 sidecar 文件；若该文件存在，则其语义为 `knowledge.md` 的来源锚点映射文件。`knowledge.map.json` 的完整规范见 [Section 12](#12-knowledge-map来源锚点映射)。
...
### 12.4 Source Contributions & Segments
...
* **[ISO 8601]** International Organization for Standardization, "Date and time — Representations for information interchange", ISO 8601.
* **[BCP 47]** Phillips, A., Ed. and M. Davis, Ed., "Tags for Identifying Languages", BCP 47, RFC 5646, September 2009. <https://www.rfc-editor.org/rfc/rfc5646>
* **[RFC 6838]** Freed, N., Klensin, J., and T. Hansen, "Media Type Specifications and Registration Procedures", BCP 13, RFC 6838, January 2013. <https://www.rfc-editor.org/rfc/rfc6838>
* **[ZIP]** PKWARE, Inc., "APPNOTE.TXT - .ZIP File Format Specification". <https://pkware.cachefly.net/webdocs/casestudies/APPNOTE.TXT>
